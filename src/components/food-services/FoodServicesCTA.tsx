...
const FoodServicesCTA = () => {
  ...
  return (
    <section
      ref={ref}
      className="relative bg-[hsl(210_15%_14%)] py-28 md:py-36 text-center overflow-hidden"
    >
      {/* Radial glows */}
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_40%_40%_at_80%_0%,hsl(210_15%_35%/0.2),transparent_60%)]" />
      </div>

      <div className="relative z-10 max-w-2xl mx-auto px-6">
        <h2
          className="font-playfair text-3xl md:text-4xl lg:text-[3.2rem] font-bold text-white mb-4 leading-[1.15]"
          style={{
            opacity: inView ? 1 : 0,
        ...
        <p
          className="text-white/45 max-w-[48ch] mx-auto mb-10 leading-[1.75] text-sm md:text-base"
          style={{
            opacity: inView ? 1 : 0,
        ...
        >
          <a
            href="#contato"
            className="inline-block relative overflow-hidden rounded-full px-10 py-4 text-sm tracking-[0.06em] text-white font-medium
