...
const galleryItems = [
  {
    src: foto01,
    alt: "Consultora NP em visita técnica à Gerbelli Doceria by Keromelo, com câmera de registro",
    category: "Consultoria em Campo",
    caption: "Visita técnica na Gerbelli Doceria",
    location: "Indaiatuba, SP",
  },
  {
    src: foto02,
    alt: "Consultora NP segurando embalagem de produto durante análise de rotulagem na doceria",
    category: "Análise de Rotulagem",
    caption: "Avaliação de produto no ponto de venda",
    location: "Campinas, SP",
  },
  {
    src: foto03,
    alt: "Nutricionista NP realizando avaliação nutricional clínica em paciente cadeirante",
    category: "Nutrição Clínica",
    caption: "Atendimento nutricional individualizado",
    location: "Indaiatuba, SP",
  },
  {
    src: foto04,
    alt: "Equipe de restaurante reunida com consultora NP após treinamento de boas práticas",
    category: "Treinamento Concluído",
    caption: "Equipe capacitada e pronta para o resultado",
    location: "Indaiatuba, SP",
  },
  {
    src: foto06,
    alt: "Consultora NP ministrando treinamento de manipuladores de alimentos em sala de reunião",
    category: "Treinamento de Equipe",
    caption: "Capacitação de manipuladores de alimentos",
    location: "Região de Campinas",
  },
  {
    src: foto10,
    alt: "Funcionária com touca e jaleco organizando buffet de saladas em restaurante comercial",
    category: "Supervisão Operacional",
    caption: "Organização e higiene no buffet",
    location: "Indaiatuba, SP",
  },
  {
    src: foto11,
    alt: "Funcionária de jaleco organizando linha de self-service com cubas de alimentos quentes",
    category: "Boas Práticas",
    caption: "Padronização da linha de produção",
    location: "Campinas, SP",
  },
  {
    src: foto13,
    alt: "Consultora NP apresentando treinamento de Boas Práticas de Fabricação em TV para equipe",
    category: "Treinamento BPF",
    caption: "Formação em Boas Práticas de Fabricação",
    location: "Indaiatuba, SP",
  },
  {
    src: foto15,
    alt: "Funcionária com touca consultando notebook com Regulamento Interno em restaurante",
    category: "Gestão Documental",
    caption: "Regulamento Interno implementado",
    location: "Região de Campinas",
  },
];
