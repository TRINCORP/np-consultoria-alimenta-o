...
const Header = () => {
  return <header className="fixed top-0 left-0 right-0 z-50 glass border-b border-border/50 shadow-sm backdrop-blur-xl">
      <div className="container-custom py-2 sm:py-3 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-4 lg:gap-8">
          ...
          <a href="#contacto" className="text-foreground hover:text-primary transition-all duration-300 text-xs lg:text-sm font-medium relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-primary after:transition-all after:duration-300 hover:after:w-full hover:scale-105">Contato</a>
        </nav>
