...
const LabelingSection = () => {
  ...
  return (
    <section className="bg-gradient-to-br from-[#2d2a28] via-[#3d3835] to-[#4a4540] text-white py-0 min-h-screen flex items-center overflow-hidden relative">
      {/* Decorative elements */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_70%,rgba(183,166,161,0.08),transparent_50%)]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(214,185,178,0.05),transparent_50%)]" />
      <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-primary/30 to-transparent" />
      <div className="absolute bottom-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-primary/30 to-transparent" />
      
      <div className="grid grid-cols-1 lg:grid-cols-2 w-full relative z-10">
        <div className="h-[400px] sm:h-[500px] lg:h-screen overflow-hidden relative group">
          <img 
            src={nutritionLabels} 
        ...
        <div className="flex items-center px-6 sm:px-8 lg:px-16 py-12 sm:py-16 lg:py-0">
          <div className="max-w-xl">
            ...
            >
              Liberte o Poder dos{' '}
              <span className="italic text-[#d6b9b2]">Rótulos de Alimentos Precisos</span>
              {' '}com a NP Rotulagem
            </h2>
            ...
            >
              Navegar pelas complexidades da rotulagem de alimentos pode ser um desafio. Na NP Consultoria Alimentos, o nosso serviço NP Rotulagem garante que os seus produtos cumprem todos os regulamentos.
            </p>
